...
public class ScheMainex{
	...
	int i = 0; // 글귀 돌리기
	int l = 0; // 테마 변경
	boolean c = true; // 시계 작동
	int dayofweek; // 요일;
	int min; // 분 정수
	int ampm; // 오전오후 정수
	int hour; // 시간 정수
	String AmPm; // 오전오후 문자
	double hortimeCount; // 수직선 위치 결정
	int dayCount;
	int grCount;
	...
	public void saying() {
		...
		say[0] = "즐거움과 행동만으로도, 시간은 부족하다.";
		say[1] = "무엇보다도, 준비가 성공의 열쇠이다.";
		say[2] = "우리가 실패에서 배우면, 실패는 성공이 된다.";
		say[3] = "한 번 실패와 영원한 실패를 혼동하지 마라.";
		say[4] = "최대한의 삶을 살고, 최대한 긍정적인 것에 집중하자.";
		say[5] = "작은 기회로 부터 종종 위대한 업적이 시작된다";

		Thread saying = new Thread() { // 명언
			public void run() {
				try {
			...
			public void run() {
				try {
					while (c == true) {
						...
						timeblock.setText(" \" " + Tempoampam + " " + hour + "시 " + min + "분 " + sec + "초 " + "\" ");
						...
						if ((8.20 <= hortimeCount) && (hortimeCount <= 9.09) && AmPm == "AM") { // 1교시
							horz.setBounds(12, 138, 477, 40);
							grCount = 1;
						} else if ((9.10 <= hortimeCount) && (hortimeCount <= 10.09) && AmPm == "AM") { // 2교시
							...
							grCount = 10;
						} else if ((1.10 <= hortimeCount) && (hortimeCount <= 1.59) && AmPm == "PM") { // 5교시
							horz.setBounds(12, 388, 477, 40);
							grCount = 5;
						} else if ((2.0 <= hortimeCount) && (hortimeCount <= 2.59) && AmPm == "PM") { // 6교시
							horz.setBounds(12, 438, 477, 40);
							grCount = 6;
						} else if ((3.0 <= hortimeCount) && (hortimeCount <= 3.59) && AmPm == "PM") { // 7교시
						...
						if (dayofweek == 2) { // 월요일
							...
							vert.setBounds(181, 103, 68, 425);
							dayCount = 2;
						} else if (dayofweek == 4) { // 수요일
							vert.setBounds(261, 103, 68, 425);
							dayCount = 3;
						} else if (dayofweek == 5) { // 목요일
							vert.setBounds(341, 103, 68, 425);
							dayCount = 4;
						} else if (dayofweek == 6) { // 금요일
							vert.setBounds(421, 103, 68, 425);
							dayCount = 5;
						}
	...
	private void initialize() {
		...
		timeblock.setFont(new Font("나눔고딕", Font.PLAIN, 14));
		...
		sayingBlock.setFont(new Font("나눔고딕", Font.PLAIN, 13));
		...
		lblNewLabel_3_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		lblNewLabel_3_2.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		lblNewLabel_3_3.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		lblNewLabel_3_2_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		JButton lightControl = new JButton("테마 변경");
		lightControl.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		mons.setFont(new Font("나눔고딕", Font.PLAIN, 13));
		...
		lblNewLabel_4_1.setFont(new Font("나눔고딕", Font.PLAIN, 13));
		...
		lblNewLabel_4_2.setFont(new Font("나눔고딕", Font.PLAIN, 13));
		...
		lblNewLabel_4_3.setFont(new Font("나눔고딕", Font.PLAIN, 13));
		...
		fri.setFont(new Font("나눔고딕", Font.PLAIN, 13));
		...
		memopad.setFont(new Font("나눔고딕", Font.PLAIN, 14));
		...
		t1_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t1_2.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t1_3.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t1_4.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t1_5.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t1_6.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t1_7.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t2_7.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t2_6.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t2_5.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t2_4.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t2_3.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t2_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t2_2.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t3_7.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t3_6.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t3_5.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t3_4.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t3_3.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t3_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t3_2.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t4_7.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t4_6.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t4_5.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t4_4.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t4_3.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t4_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t4_2.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t5_6.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t5_5.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t5_4.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t5_3.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t5_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		t5_2.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		JButton ClockControl_1 = new JButton("시계 정지");
		ClockControl_1.setFont(new Font("나눔고딕", Font.PLAIN, 11));
		...
		ClockControl_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (c == true) {
					ClockControl_1.setText("시계 시작");
					c = false;
				} else if (c == false) {
					ClockControl_1.setText("시계 정지");
					c = true;
					clock();
				}
